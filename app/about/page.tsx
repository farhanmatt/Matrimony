...
export const metadata: Metadata = {
  ...
  description:
    "Learn about MIP Matrimony — India's most trusted matrimony platform. Our mission is to connect families and build happy marriages.",
      ...
      <div className="pt-28 pb-24">
        ...
        <div className="max-w-4xl mx-auto px-4 text-center mb-16">
          ...
          <p className="text-lg text-gray-600 leading-relaxed max-w-2xl mx-auto">
            Founded in 2015, MIP Matrimony was built with a single purpose — to
