...
export default function AdminPaymentFilters({ activeCount = 0 }: AdminPaymentFiltersProps) {
  ...
  const currentActiveCount = useMemo(() => {
    const keys: (keyof DraftFilters)[] = ["status", "amountMin", "amountMax", "dateFrom", "dateTo"];
            ...
            <div className="mb-6 flex items-start justify-between gap-4">
              <div>
                ...
                <h2 className="mt-2 font-display text-2xl font-bold text-gray-900">
                  Narrow your payment list
                </h2>
                <p className="mt-1 text-sm text-gray-500">
                  Use payment filters to find the right transactions faster.
                </p>
              </div>
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              <div>
                ...
                <select
                  ...
                  className="w-full rounded-2xl border border-rose-100 px-4 py-3 text-sm focus:outline-none focus:ring-2 focus:ring-rose-500"
                >
              ...
              <div>
                ...
                <input
                  ...
                  min="0"
                  step="1"
                  value={drafts.amountMin}
                  onChange={(event) =>
                    setDrafts((current) => ({ ...current, amountMin: event.target.value }))
                  }
                  placeholder="e.g., 500"
                  className="w-full rounded-2xl border border-rose-100 px-4 py-3 text-sm focus:outline-none focus:ring-2 focus:ring-rose-500"
                />
              ...
              <div>
                ...
                <input
                  ...
                  min="0"
                  step="1"
                  value={drafts.amountMax}
                  onChange={(event) =>
                    setDrafts((current) => ({ ...current, amountMax: event.target.value }))
                  }
