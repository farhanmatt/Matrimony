  ...
  return (
    <div className="mx-auto max-w-6xl space-y-6">
      ...
      <section className="grid gap-6 xl:grid-cols-[320px_minmax(0,1fr)] xl:items-start">
        <aside className="self-start overflow-y-auto rounded-[28px] border border-rose-100/80 bg-white p-5 shadow-[0_18px_45px_rgba(15,23,42,0.06)] h-[420px] sm:h-[460px] xl:h-[520px]">
