...
export default function AdminProfilesTable({
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="flex flex-col gap-3 border-t border-slate-100 px-4 pt-4 sm:flex-row sm:items-center sm:justify-between">
        ...
        <div ref={bulkMenuRef} className="relative">
          ...
          {bulkOpen ? (
            <div className="absolute left-0 bottom-14 z-20 w-56 overflow-hidden rounded-2xl border border-slate-100 bg-white shadow-xl">
              <button
                type="button"
