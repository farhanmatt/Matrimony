    ...
    <div className="space-y-4">
      <div className="px-4 pt-4 sm:px-4">
        <div className="overflow-x-auto [scrollbar-width:none] [-ms-overflow-style:none] [&::-webkit-scrollbar]:hidden">
            <table className="w-full min-w-[1400px] table-fixed text-sm xl:min-w-full">
            <colgroup>
              <col style={{ width: "4%" }} />
              <col style={{ width: "18%" }} />
              <col style={{ width: "28%" }} />
            ...
            <thead>
              <tr className="border-b border-slate-100 bg-slate-50/90">
                <th className="w-10 px-[15px] py-3.5 text-left">
                  <SelectableCheckbox checked={allSelected} onChange={toggleAll} ariaLabel="Select all users" />
                </th>
                <th className="px-[15px] py-3 text-left text-[13px] font-semibold uppercase tracking-[0.16em] text-slate-700">
                  User
                </th>
                <th className="px-[15px] py-3 text-left text-[13px] font-semibold uppercase tracking-[0.16em] text-slate-700">
                  Contact
            ...
            <tbody className="divide-y divide-slate-100">
              {visibleUsers.map((user) => {
                ...
                return (
                  <tr key={user.id} className={cn("transition-colors hover:bg-slate-50/80", checked && "bg-rose-50/50")}>
                      ...
                      <div className="flex items-center gap-2.5">
                        {imageSrc ? (
                          <AdminPreviewableImage
                            ...
                            className="relative block h-11 w-11 shrink-0 overflow-hidden rounded-full bg-gradient-to-br from-rose-100 via-white to-pink-100 shadow-sm ring-1 ring-slate-100"
                    ...
                    <td className="px-[15px] py-4 align-middle">
                      <div className="relative flex justify-center">
                        <button
                          ...
                          className="inline-flex h-9 w-9 items-center justify-center rounded-full border border-slate-200 bg-white text-slate-500 shadow-sm transition-colors hover:border-violet-200 hover:text-violet-600"
