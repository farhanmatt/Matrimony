// Generated from C:/Users/ADMIN/Downloads/City-List (1).pdf.
// The source PDF contains state and city names only; it does not include pincodes.
...
export const STATE_CITY_DATA = {
  ...
  "West Bengal": [
    ...
    "Baniban Jagadishpur",
    "Bankra",
    "Bankra North Twenty Four Parganas District",
    "Bankul",
    "Bankura",
    "Bansberia",
    "Banshra",
...
export const STATE_OPTIONS = Object.keys(STATE_CITY_DATA);
...
export function getPincodeForCity(state?: string | null, city?: string | null) {
  ...
  return CITY_PINCODE_DATA[`${state}::${city}`] ?? "";
}
